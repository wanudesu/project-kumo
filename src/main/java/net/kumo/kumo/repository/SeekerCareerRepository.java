...
public interface SeekerCareerRepository extends JpaRepository<SeekerCareerEntity, Long> {
    ...
    /**
     * 특정 사용자의 전체 경력 내역을 데이터베이스에서 일괄 삭제합니다. (이력서 수정 또는 회원 탈퇴 시 사용)
     *
